    ...
    const ContentWorks = [
        {
            ...
            git: "https://github.com/Sofia-Gutierrez/Servicio-de-podas"
        },
        {
            img: travel,
            ...
            link: "",
            alt: "Medellín Travel",
            git: "https://github.com/anariosp91/grupo2Transporte"
        },
        {
            img: museum,
            ...
            git: "https://github.com/gabrielTettamanti/museoPaleontologicoDeSanPedro"
        },
        {
            img: mercadoLiebre,
        ...
        return(
            <div className="works-container" id="works"> 
                 {ContentWorks.map((element, index) => {
                        return (
                            <Work key={index + element.title} title={element.title} description={element.description} img={element.img} link={element.link}  alt={element.alt} git={element.git} />
                            )
                        })
                    }
            </div>
